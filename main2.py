...
LEVEL_UP_CHANNEL_ID = 123456789012345678  # استبدله بـ ID روم الترقية الخاص بسيرفرك
...
# رتب المستويات (المستوى: ID الرتبة)
LEVEL_ROLES = {
...
def save_user_data(user_id, xp, level):
    """حفظ أو تحديث بيانات مستخدم في MongoDB"""
    try:
...
async def on_message(message):
    ...
    # معالجة النقاط فقط للرسائل العادية
    ...
    # السماح بتشغيل الأوامر مثل !rank
